  ...
  const features = [
    {
      ...
      description:
          "Egyetemen sokaknak ez az egyik legnehezebb tantárgy, mert sosem értették meg az alapokat. Az adatbázis-kezelés ugyanis nem Microsoft Access-ben történő táblák kötögetéséről szól. Megtanulsz SQL nyelven lekérdezéseket írni, és beszélünk más, nem relációs adatbázisokról is.",
      icon: <IconDatabase />,
    },
    {
      title: "Táblázatkezelés",
      description:
          "Az egyik legérdekesebb rész, ahol segítünk neked, hogy az átlagos Excel-felhasználótól eltérően te több mint 5-10%-át használd a funkcióknak. És természetesen elmondunk mindent, amit tudni kell a függvényekről, diagramokról, pivot-táblákról és makrókról.   ",
    ...
    {
      title: "Programozás",
      description: "Mi nem Python-t tanítunk, hanem C#-ot, így később, ha egyetemre mész, és meg kell ismerkedned a jó öreg C programnyelvvel, az már ismerős lesz. Ha pedig nem tervezel többet programozni, akkor se izgulj, igazából nem nehezebb mint a Python, csak több a pontosvessző.",
      icon: <IconBrandCSharp />,
    },
    {
      title: "Power Point",
      description: "Valószínűleg azt gondolod, hogy sok újdonságot már nem lehet neked mutatni, mert gyerekkorod óta használod… Azért mi megpróbáljuk!",
      icon: <IconRouteAltLeft />,
    },
    {
      title: "Weblapszerkesztés",
      description:
          "Hozd létre életed első weboldalát! Megtanítjuk a HTML5 és a CSS alapjait, majd azt is, hogy hogyan lehet mindezt egyszerűbben is…",
      icon: <IconHelp />,
    },
  ];
  return (
...
const Feature = ({
  ...
  return (
      ...
      >
        ...
        <p className="text-sm lg:text-lg text-neutral-600 dark:text-neutral-600 relative z-10 text-justify">
          {description}
        </p>
      </div>
  );
